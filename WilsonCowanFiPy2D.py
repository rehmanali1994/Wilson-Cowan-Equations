# -*- coding: utf-8 -*-
"""
Created on Tue Jun 23 11:36:16 2015
...
class WilsonCowan2D:
    ...
    def imgWilsonCowan2D(self, tval, yvals, pltType):
        ...
        if pltType == 2: 
            ...
            eps_0 = 1; alpha = (self.Lx+self.dx)/np.log(1000);
...
" Make a volshow and a torus plot and a cylinder plot"

" Zeroth: ANIMATE THESE PLOTS "

" First: Clean up code to be more general and object oriented "        
