# -*- coding: utf-8 -*-
"""
Created on Fri Aug 21 14:19:42 2015

@author: rehmanali
"""

from WilsonCowanSystemsHeavisideEuler import *
...
def WC1Dmain():
    ...
    dt = 0.005; tmore = 10; # Time Step and Initlal Integration Time
...
#    # For Standing Wave (AKA: Honeycomb)
#    u0 = 0.001*np.random.randn((nx))+0.44; 
